...
public class CadastrarUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Ir Para Interface");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       // Supondo que você tenha uma classe chamada OtherInterface que representa a outra interface
LayoutLoja otherInterface = new LayoutLoja();
otherInterface.setVisible(true);
this.dispose(); // Fechar a interface atual após abrir a outra interface
